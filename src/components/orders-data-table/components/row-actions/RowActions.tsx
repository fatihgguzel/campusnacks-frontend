...
export const RowActions: React.FC<IRowActions> = React.memo(
  ({ orderId, isUserOrders }) => {
        ...
        {!isUserOrders && (
          <>
            <Button
              ...
              onClick={() =>
                handleStatusChange(Enums.OrderStatusTypes.ONDELIVER)
              }
            />
            <Button
              text={t('set_complete')}
              ...
              onClick={() =>
                handleStatusChange(Enums.OrderStatusTypes.COMPLETED)
              }
            />
            <Button
              text={t('cancel_order')}
              ...
              onClick={() =>
                handleStatusChange(Enums.OrderStatusTypes.CANCELLED)
              }
            />
          </>
        )}
